  ...
  <div id="base-list-layout">
    <div class="ui-posts">
      <div v-for="page in pages" :key="page.key" class="ui-post">
		...
		<div class="ui-post-info" v-if="page.frontmatter">
			<div v-if="page.frontmatter.author" class="ui-post-author isolation-right">
			  <NavigationIcon />
			  <span
			...
			<div v-if="page.frontmatter.date" class="ui-post-date isolation-right">
			  <ClockIcon />
